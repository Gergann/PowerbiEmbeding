...
async function setReportPage(report,pageNumber){
    try {
...
$.ajax({
    ...
    success: function (embedData) {
        ...
        report.on("loaded", function () {
            ...
            document.getElementById("pageTwo").addEventListener("click", function() {
                setReportPage(report,2)
              });
        });
